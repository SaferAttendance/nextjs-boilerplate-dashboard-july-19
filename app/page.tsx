...
export default function Page() {
  ...
  const selectPlan = (plan: string) => {
    ...
    alert(`Starting your free trial with the ${plan} plan! No credit card required.`);
  };
  ...
  useEffect(() => {
    ...
    const anchorHandlers: Array<{ el: HTMLAnchorElement; handler: (e: Event) => void }> = [];
  ...
  return (
    <main className="font-montserrat bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 min-h-screen relative">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <p className="text-xl md:text-2xl text-gray-600 mb-8 leading-relaxed max-w-2xl">
                The complete school safety platform that transforms attendance tracking into comprehensive student
                protection with real-time alerts and emergency response.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Every minute counts in an emergency. Traditional attendance methods leave dangerous gaps in student
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-300">
                Paper-based systems create critical delays when every second matters for student safety.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-300">
                Parents left wondering about their child&apos;s safety due to outdated notification systems.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-300">
                Missing patterns and trends that could prevent issues before they become emergencies.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Everything you need to keep students safe, parents informed, and administrators confident in one integrated
              platform.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white/70 backdrop-blur-xl rounded-2xl p-8 shadow-lg shadow-gray-200/50 border border-white/20 hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-gray-600 mb-4">
                Instant attendance updates across all classrooms with live dashboard monitoring and automated alerts.
              </p>
            ...
            <div className="bg-white/70 backdrop-blur-xl rounded-2xl p-8 shadow-lg shadow-gray-200/50 border border-white/20 hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-gray-600 mb-4">
                Instant emergency protocols with automated parent notifications and real-time student accountability.
              </p>
              <ul className="text-sm text-gray-600 space-y-2">
                <li className="flex items-center">
            ...
            <div className="bg-white/70 backdrop-blur-xl rounded-2xl p-8 shadow-lg shadow-gray-200/50 border border-white/20 hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-gray-600 mb-4">
                Automated parent alerts for absences, tardies, and emergencies via SMS, email, and app notifications.
              </p>
              <ul className="text-sm text-gray-600 space-y-2">
                <li className="flex items-center">
            ...
            <div className="bg-white/70 backdrop-blur-xl rounded-2xl p-8 shadow-lg shadow-gray-200/50 border border-white/20 hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-gray-600 mb-4">
                Comprehensive reporting and insights to identify patterns and improve student engagement.
              </p>
              <ul className="text-sm text-gray-600 space-y-2">
                <li className="flex items-center">
            ...
            <div className="bg-white/70 backdrop-blur-xl rounded-2xl p-8 shadow-lg shadow-gray-200/50 border border-white/20 hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-gray-600 mb-4">
                Seamless integration with existing school information systems and student databases.
              </p>
              <ul className="text-sm text-gray-600 space-y-2">
                <li className="flex items-center">
            ...
            <div className="bg-white/70 backdrop-blur-xl rounded-2xl p-8 shadow-lg shadow-gray-200/50 border border-white/20 hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-gray-600 mb-4">
                Bank-level security with FERPA compliance and comprehensive data protection protocols.
              </p>
              <ul className="text-sm text-gray-600 space-y-2">
                <li className="flex items-center">
      ...
      {/* Testimonials */}
      <section id="testimonials" className="relative py-20 bg-gradient-to-br from-brand-blue/5 to-brand-light/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              Trusted by School Leaders{" "}
              <span className="bg-gradient-to-r from-brand-blue to-brand-dark bg-clip-text text-transparent">Nationwide</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              See how schools are transforming safety and communication with Safer Attendance.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white/80 backdrop-blur-xl rounded-2xl p-8 shadow-lg shadow-gray-200/50 border border-white/20">
              ...
              <p className="text-gray-600 mb-6 italic">
                &quot;Safer Attendance transformed our emergency response capabilities. During our last drill, we had
                complete student accountability in under 3 minutes. Parents received instant updates, and our stress
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-600">Principal, Springfield Elementary</div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/80 backdrop-blur-xl rounded-2xl p-8 shadow-lg shadow-gray-200/50 border border-white/20">
              ...
              <p className="text-gray-600 mb-6 italic">
                &quot;The parent communication features are incredible. Parents love getting instant notifications, and
                our office calls have decreased by 80%. The system pays for itself in administrative time savings
                alone.&quot;
              </p>
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-600">Superintendent, Metro District</div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/80 backdrop-blur-xl rounded-2xl p-8 shadow-lg shadow-gray-200/50 border border-white/20">
              ...
              <p className="text-gray-600 mb-6 italic">
                &quot;Implementation was seamless, and our teachers adapted quickly. The mobile app makes attendance
                tracking effortless, and the analytics help us identify students who need additional support before
                issues escalate.&quot;
              </p>
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-600">Assistant Principal, Valley High</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <section id="pricing" className="relative py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Choose the plan that fits your school&apos;s size and needs. All plans include our core safety features.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white/70 backdrop-blur-xl rounded-2xl p-8 shadow-lg shadow-gray-200/50 border border-white/20 hover:shadow-xl transition-all duration-300">
              <div className="text-center mb-8">
                ...
                <div className="text-sm text-gray-500 mt-2">Up to 500 students</div>
              </div>
              ...
              <ul className="space-y-3 mb-8">
                {[
                  ...
                  <li key={item} className="flex items-center">
                    <svg className="w-5 h-5 text-safety-green mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="bg-gradient-to-br from-brand-blue/10 to-brand-light/20 backdrop-blur-xl rounded-2xl p-8 shadow-xl shadow-brand-blue/20 border-2 border-brand-blue/30 hover:shadow-2xl transition-all duration-300 relative">
              ...
              <div className="text-center mb-8">
                ...
                <div className="text-gray-600">per student/month</div>
                <div className="text-sm text-gray-500 mt-2">Up to 2,000 students</div>
              </div>
            ...
            <div className="bg-white/70 backdrop-blur-xl rounded-2xl p-8 shadow-lg shadow-gray-200/50 border border-white/20 hover:shadow-xl transition-all duration-300">
              <div className="text-center mb-8">
                ...
                <div className="text-sm text-gray-500 mt-2">Unlimited students</div>
              </div>
          ...
          <div className="text-center mt-12">
            ...
            <div className="flex flex-wrap justify-center gap-6 text-sm text-gray-500">
              <div className="flex items-center">
                <svg className="w-4 h-4 text-safety-green mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
                FERPA Compliant
              </div>
      ...
      {/* Security Section */}
      <section id="security" className="relative py-20 bg-gradient-to-br from-gray-900 to-gray-800 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              Bank-Level Security <span className="text-accent-emerald">You Can Trust</span>
            </h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Your student data deserves the highest level of protection. We exceed industry standards for educational
              data security.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-300 text-sm">Full compliance with educational privacy regulations</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-300 text-sm">Granular permissions for different user types</p>
            </div>

            <div className="text-center">
              <div className="w-16 h-16 bg-accent-orange/20 rounded-xl flex items-center justify-center mx-auto mb-4">
                <svg className="w-8 h-8 text-accent-orange" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2m0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v4a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                </svg>
              </div>
              <h3 className="text-lg font-bold mb-2">Audit Trails</h3>
              <p className="text-gray-300 text-sm">Complete logging of all system activities</p>
            </div>
          </div>

          <div className="mt-16 text-center">
            <div className="bg-white/10 backdrop-blur-xl rounded-2xl p-8 max-w-4xl mx-auto">
              <h3 className="text-2xl font-bold mb-4">Trusted by School Districts Nationwide</h3>
              <p className="text-gray-300 mb-6">
                Our security practices are regularly audited and certified by independent third parties. We maintain SOC
                2 Type II compliance and undergo annual penetration testing.
              </p>
              <div className="flex flex-wrap justify-center gap-8 text-sm">
                {["SOC 2 Type II Certified", "Annual Penetration Testing", "24/7 Security Monitoring"].map((item) => (
          ...
          <div className="bg-gradient-to-r from-brand-blue to-brand-dark rounded-3xl p-12 lg:p-20 text-center text-white relative overflow-hidden">
            ...
            <div className="relative z-10">
              <h2 className="text-4xl md:text-6xl font-bold mb-6">
                Ready to Make Your School <span className="text-accent-emerald">Safer?</span>
              </h2>
              <p className="text-xl md:text-2xl mb-8 opacity-90 max-w-3xl mx-auto">
                Join hundreds of schools already using Safer Attendance to protect their students and keep parents
                informed.
              </p>
              ...
              <p className="text-sm opacity-75">No credit card required • Setup in under 24 hours • Cancel anytime</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <footer className="relative bg-gray-900 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="text-gray-400 mb-6 max-w-md">
                Transforming school safety through intelligent attendance management, real-time communication, and
          ...
          <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400">
            <p>&copy; 2024 Safer Attendance. All rights reserved. Keeping schools safe, one student at a time.</p>
          </div>
        </div>
      </footer>
    </main>
