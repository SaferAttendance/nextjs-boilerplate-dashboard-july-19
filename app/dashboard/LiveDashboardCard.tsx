    ...
    <div className="rounded-2xl border border-gray-100 bg-white p-6 shadow-sm">
      ...
      <div className="mb-4 grid grid-cols-2 gap-3">
        <div className="rounded-xl border border-gray-100 bg-white p-3">
          ...
          <p className="mt-1 text-2xl font-bold text-gray-900">{loading ? '—' : data?.present ?? 0}</p>
        </div>
        <div className="rounded-xl border border-gray-100 bg-white p-3">
      ...
      {/* CTA */}
      <button
        className="inline-flex w-full items-center justify-center rounded-lg bg-gradient-to-r from-rose-500 to-red-600 px-3 py-2 text-sm font-semibold text-white shadow transition hover:from-rose-600 hover:to-red-700"
        onClick={() => alert('Emergency Protocol triggered (placeholder).')}
      >
        <span className="mr-2">🚨</span> Emergency Protocol
      </button>
