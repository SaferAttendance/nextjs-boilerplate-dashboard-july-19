...
export default async function CsvPage() {
  ...
  // Auth (same pattern as other dashboard pages)
  ...
  return (
    <main className="font-montserrat bg-gradient-to-br from-brand-blue via-brand-light to-white min-h-screen relative">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-xl font-bold text-gray-800">CSV Export</h1>
                <p className="text-sm text-gray-600">Download attendance data</p>
              </div>
            </div>
      ...
      {/* Content */}
      <section className="relative max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-20 z-10 text-center">
        <CsvDownload />
      </section>
    </main>
  );
