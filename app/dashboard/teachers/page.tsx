        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            ...
            <div className="flex items-center space-x-4">
              <Link href="/dashboard" className="p-2 hover:bg-gray-100 rounded-lg transition-colors duration-200" aria-label="Back to dashboard">
            ...
            <div className="flex items-center space-x-4">
              <div className="text-right">
                ...
                {/* Optionally, you could display last login if available */}
              </div>
              ...
              {/* Optionally, you could add a Logout button here */}
            </div>
          </div>
        </div>
      </header>
