// app/dashboard/view-all-subs/page.tsx
import Link from 'next/link';
import { cookies } from 'next/headers';
import { redirect } from 'next/navigation';
import ViewAllSubstitutes from './ViewAllSubstitutes';

export const runtime = 'nodejs';

export default async function ViewAllSubsPage() {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-xl font-bold text-gray-800">All Registered Substitutes</h1>
                <p className="text-sm text-gray-600">View all substitute teachers in the system</p>
              </div>
            </div>
            <div className="flex items-center space-x-4">
