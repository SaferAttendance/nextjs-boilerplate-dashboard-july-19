// app/dashboard/teacher/csv/TeacherCsvDownload.tsx
'use client';
...
/*  Main component                                                     */
/* ------------------------------------------------------------------ */
export default function TeacherCsvDownload() {
  ...
  async function handleDownload() {
    ...
    try {
      ...
      const res = await fetch('/api/xano/teacher-csv', { method: 'GET', cache: 'no-store' });
  ...
  return (
    <>
      ...
      {/* Header inside the page content */}
      <header className="mb-10 flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold text-neutral-900">Export Your Class Attendance</h1>
          <p className="text-neutral-600">Download attendance records for all your classes</p>
        </div>
      </header>
      ...
      <section className="mb-12 rounded-2xl border border-neutral-200 bg-white shadow-sm overflow-hidden">
        <div className="bg-gradient-to-r from-brand-blue/5 to-brand-blue/10 px-6 py-5 border-b border-neutral-200 flex items-start justify-between">
          <div>
            <h2 className="text-xl font-semibold text-neutral-900 mb-1">Your class attendance data</h2>
            <p className="text-neutral-600">Complete attendance records for students in your classes</p>
          </div>
        ...
        <div className="p-6">
          ...
          <div className="mb-8 space-y-3">
            <h3 className="text-lg font-semibold text-neutral-900 mb-3">What's included in your export</h3>
            {[
              ['Student Information', 'Student IDs, names, and contact details'],
              ['Class Details', 'All your assigned classes and periods'],
              ['Attendance Records', 'Present, absent, and pending statuses with timestamps'],
              ['Contact Information', 'Parent/guardian contact details for follow-up'],
            ].map(([title, desc]) => (
              <div key={title} className="flex items-start gap-3 rounded-xl bg-neutral-50 p-4">
          ...
          <div className="mb-8">
            <div className="mb-4 flex items-center justify-between">
              <h3 className="text-lg font-semibold text-neutral-900">Data columns</h3>
              <button
                ...
                <table className="w-full text-sm">
                  ...
                  <tbody className="divide-y divide-neutral-100">
                    {[
                      ...
                      ['student_name', 'Full student name', 'John Smith'],
                      ['attendance_status', 'Present / Absent / Pending', 'Present'],
                      ['class_name', 'Name of the class', 'Mathematics'],
                      ['period', 'Class period number', '3'],
                      ['parent_email', 'Parent contact email', 'parent@example.com'],
                      ['parent_phone', 'Parent phone number', '555-0123'],
                    ].map(([col, desc, ex]) => (
          ...
          <div className="mb-8 rounded-xl border border-brand-blue/20 bg-brand-blue/5 p-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-sm font-medium text-neutral-900 mb-1">Privacy & Security</p>
                <p className="text-sm text-neutral-700">
                  This export contains only data for students in your assigned classes. Please handle this information 
                  responsibly and in accordance with your school's privacy policies.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mb-8 rounded-xl border border-safety-green/20 bg-safety-green/10 p-4">
            <div className="flex items-start gap-3">
              ...
              <p className="text-sm text-neutral-700">
                <strong>Teacher tip:</strong> Use this data to identify attendance patterns, reach out to parents of 
                frequently absent students, and maintain accurate records for parent-teacher conferences.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center gap-2 sm:flex-row sm:justify-between">
            <div className="text-center sm:text-left">
              <p className="text-sm text-neutral-600">Ready to export your class data?</p>
              <p className="text-xs text-neutral-500">File will be saved as &quot;teacher_attendance.csv&quot;</p>
            </div>
